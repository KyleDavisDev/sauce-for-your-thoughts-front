export const dummyData = [
  ...
  },
  {
    ...
    date: "2017-03-13T14:12:08.255Z",
    sauce: "5",
    author: "2",
    overall: { rating: 4, txt: "here is some test text" },
    label: { rating: 4, txt: "here is some test text" },
    aroma: { rating: 4, txt: "On the mild side, but balanced well" },
    taste: { rating: 4, txt: "here is some test text" },
    heat: { rating: 4, txt: "On the mild side, but balanced well" },
    note: {
      rating: 4,
      txt:
        "Ive had some umami hot sauces that are too complex in flavor profile and stumble over themselves.... this is not it."
  ...
  },
  {
    ...
    heat: { rating: 4, txt: "here is some test text" },
    note: { rating: 4, txt: "On the mild side, but balanced well" }
  },
  {
    _id: "58c6a8e5fb4d61115815f8b7",
    date: "2017-03-13T14:12:53.559Z",
    sauce: "5",
    author: "4",
    overall: { rating: 4, txt: "here is some test text" },
    label: {
